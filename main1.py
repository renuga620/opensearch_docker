...
NAIOPS_PREDICT_NODE_NAME      = os.getenv("NAIOPS_PREDICT_NODE_NAME"    ,"S3_EO_SKL_A9006")
NAIOPS_PREDICT_IFDESCR        = os.getenv("NAIOPS_PREDICT_IFDESCR"      ,"ifdescr")
NAIOPS_PREDICT_IFDESCR_NAME   = os.getenv("NAIOPS_PREDICT_IFDESCR_NAME" ,"tunnel-te1072")
...
NAIOPS_PREDICT_HISTORY        = os.getenv("NAIOPS_PREDICT_HISTORY"      ,"240") 
